...
# get the min element
print("Peek of minimum element: " + str(arr[0]))

# Extract min - get the min element from array and delete from the array
print("Extract Min: " + str(arr[0]))
